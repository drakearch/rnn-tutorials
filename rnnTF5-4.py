...
print()
print("expand_dims: ", tf.expand_dims(batchX_placeholder, -1))
print()
...
states_series, current_state = tf.nn.dynamic_rnn(cell, tf.expand_dims(batchX_placeholder, -1), sequence_length=seq_len, dtype=tf.float32)
